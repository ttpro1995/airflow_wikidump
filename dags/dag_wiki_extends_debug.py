...
@dag(
    ...
    end_date=pendulum.datetime(2021, 1, 10, tz="UTC"),
    catchup=True,
    tags=["wiki"]
)
def wiki_pageview_dag_extends_debug():
    ...
    output = call_api(page_name=list_of_tracked_wiki[1])
    ingest_mysql(output)
...
wiki_pageview_dag_extends_debug()